    ...
    request_body = {
        ...
        "instructions": "\n".join(
            [
                ...
                "details must include specific context: who said what, what was decided, what source condition matters, and what finished state Alan should see. Write polished sentences with normal punctuation; do not paste fragments together, repeat the task in slightly different words, or leave high-ease tasks as thin one-sentence summaries.",
                ...
                "why must explain both scores in one short source-grounded sentence that reads naturally after the task/details text. Do not write motivational copy, sentence fragments, repeated wording from details, or pasted-together clauses without punctuation.",
